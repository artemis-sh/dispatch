...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): Config {
  const config = {
    ...
    revisionResolverLeaseDurationMs: readTimerDelay(env.DISPATCH_REVISION_RESOLVER_LEASE_DURATION_MS, 60_000),
    ...
    githubIssueAcknowledgmentLeaseDurationMs: readTimerDelay(env.DISPATCH_GITHUB_ISSUE_ACKNOWLEDGMENT_LEASE_DURATION_MS, 60_000),
    ...
    scheduleWorkerLeaseDurationMs: readTimerDelay(env.DISPATCH_SCHEDULE_WORKER_LEASE_DURATION_MS, 60_000),
